    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50" onClick={onClose}>
        <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full relative" onClick={(e) => e.stopPropagation()}>
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Eliminar Comunidad</h2>
          <p className="text-gray-600 mb-6">¿Estás seguro de que deseas eliminar esta comunidad?</p>
...
">
  ...
  export default ModalEliminarComunidad;
