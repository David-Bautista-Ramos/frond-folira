  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="mb-4 text-2xl text-primary">Marcar como leida la Notificacion</h2>
        <p className="mb-5 text-gray-600 text-base">¿Estás seguro de que deseas marcar como leida esta notificacion?</p>
