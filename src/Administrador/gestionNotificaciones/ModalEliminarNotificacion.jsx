...
function ModalEliminarNotificacion({ isOpen, onClose, NotificacionId, obtenerNotificaciones }) {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <h2 className="mb-4 text-2xl text-gray-800">Eliminar Notificacion</h2>
          <p className="mb-5 text-gray-600 text-base">¿Estás seguro de que deseas eliminar esta Notificacion?</p>
  ...
  export default ModalEliminarNotificacion;